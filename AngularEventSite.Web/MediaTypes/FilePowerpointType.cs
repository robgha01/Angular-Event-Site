// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FilePowerpointType.cs" company="BlueLeet">
//   Copyright (C) BlueLeet - All Rights Reserved
//   Unauthorized copying of this file, via any medium is strictly prohibited
//   Proprietary and confidential
// </copyright>
// <summary>
//   Defines a file Powerpoint type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace AngularEventSite.Web.MediaTypes
{
    ...
    /// </summary>
    [MediaType(
        Icon = "icon-fa-file-powerpoint-o",
        IconColor = "color-orange",
        DisplayName = "#FilePowerpointType name",
        Description = "#FilePowerpointType description")]
    public class FilePowerpointType : UCodeFirstMediaTypeBase
    {
        /// <inheritdoc />
        public FilePowerpointType(IPublishedContent content)
            : base(content)
        {
        }
