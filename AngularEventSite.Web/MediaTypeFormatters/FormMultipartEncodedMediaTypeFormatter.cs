namespace AngularEventSite.Web.MediaTypeFormatters
{
    using System;
    ...
    public class FormMultipartEncodedMediaTypeFormatter : MediaTypeFormatter
    {
        ...
        private object BindToModel(IDictionary<string, object> data, Type type, IFormatterLogger formatterLogger)
        {
            ...
            using (var config = new HttpConfiguration())
            {
                ...
                var metadataProvider =
                    actionContext.ControllerContext.Configuration.Services.GetModelMetadataProvider();
        ...
        private async Task<IDictionary<string, object>> ToModelDictionaryAsync(
            MultipartMemoryStreamProvider multipartProvider)
        {
            ...
            foreach (var part in multipartProvider.Contents)
            {
                ...
                // if we have a filename, we treat the part as file upload, otherwise as simple
                // string, model binder will convert strings to other types.
