namespace AngularEventSite.Web.Extensions
{
    ...
    public static class HtmlLabelExtensions
    {
        ...
        public static MvcLabel BeginLabel(
        ...
        public static MvcLabel BeginLabelFor<TModel, TValue>(
        ...
        public static MvcLabel BeginLabelForModel(
            this HtmlHelper html,
            string labelText,
            IDictionary<string, object> htmlAttributes)
        {
        ...
        internal static MvcLabel LabelHelper(
            HtmlHelper html,
